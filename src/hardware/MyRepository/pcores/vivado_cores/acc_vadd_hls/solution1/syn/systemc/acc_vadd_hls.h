...
#ifndef _acc_vadd_hls_HH_
#define _acc_vadd_hls_HH_
...
struct acc_vadd_hls : public sc_module {
    ...
    // Module declarations
    acc_vadd_hls(sc_module_name name);
    SC_HAS_PROCESS(acc_vadd_hls);
    ...
    sc_signal< sc_lv<32> > op_reg_228;
    sc_signal< sc_lv<32> > end_reg_234;
    sc_signal< sc_lv<1> > tmp_reg_247;
    sc_signal< sc_lv<1> > tmp_2_reg_251;
    sc_signal< sc_lv<64> > tmp_s_fu_173_p1;
    sc_signal< sc_lv<64> > tmp_s_reg_258;
    sc_signal< sc_lv<1> > tmp_8_fu_168_p2;
    sc_signal< sc_lv<1> > tmp_10_fu_179_p2;
    sc_signal< sc_lv<1> > tmp_10_reg_273;
    sc_signal< sc_lv<64> > tmp_5_fu_190_p1;
    sc_signal< sc_lv<64> > tmp_5_reg_280;
    sc_signal< sc_lv<1> > tmp_3_fu_185_p2;
    sc_signal< sc_lv<1> > tmp_7_fu_196_p2;
    sc_signal< sc_lv<1> > tmp_7_reg_295;
    sc_signal< sc_lv<32> > i_3_fu_209_p2;
    sc_signal< sc_logic > ap_sig_ioackin_resp_TREADY;
    sc_signal< sc_lv<32> > i_2_fu_222_p2;
    sc_signal< sc_lv<32> > i_1_reg_128;
    sc_signal< sc_lv<32> > i_reg_138;
    sc_signal< sc_logic > ap_reg_ioackin_resp_TREADY;
    sc_signal< sc_lv<32> > b_Addr_A_orig;
    sc_signal< sc_lv<32> > a_Addr_A_orig;
    sc_signal< sc_lv<32> > tmp_9_fu_202_p2;
    sc_signal< sc_lv<32> > tmp_6_fu_215_p2;
    ...
    void thread_tmp_10_fu_179_p2();
    void thread_tmp_2_fu_163_p2();
    void thread_tmp_3_fu_185_p2();
    void thread_tmp_5_fu_190_p1();
    void thread_tmp_6_fu_215_p2();
    void thread_tmp_7_fu_196_p2();
    void thread_tmp_8_fu_168_p2();
