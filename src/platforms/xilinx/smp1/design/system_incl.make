...
BRAMINIT_ELF_FILES =  $(CORE_TEST_OUTPUT) $(MB_HWT0_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe microblaze0 $(CORE_TEST_OUTPUT)  -pe microblaze1 $(MB_HWT0_OUTPUT) 

ALL_USER_ELF_FILES = $(CORE_TEST_OUTPUT) $(MB_HWT0_OUTPUT) 
...
LIBSCLEAN_TARGETS = microblaze0_libsclean microblaze1_libsclean 

PROGRAMCLEAN_TARGETS = Core_Test_programclean MB_HWT0_programclean 
...
implementation/main_group1_bridge_wrapper.ngc \
...
CORE_TEST_CC_INFERRED_FLAGS= -mxl-soft-mul -mhard-float -mxl-barrel-shift -mcpu=v8.00.a 
