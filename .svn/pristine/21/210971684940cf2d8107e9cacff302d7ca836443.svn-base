...
/* Definitions for peripheral MAIN_VHWTI_BRIDGE1 */
#define XPAR_MAIN_VHWTI_BRIDGE1_BRIDGE_BASEADDR 0x70040000
#define XPAR_MAIN_VHWTI_BRIDGE1_BRIDGE_HIGHADDR 0x7004FFFF
#define XPAR_MAIN_VHWTI_BRIDGE1_RNG0_BASEADDR 0xC0000000
#define XPAR_MAIN_VHWTI_BRIDGE1_RNG0_HIGHADDR 0xC007FFFF
...
/* Definitions for peripheral DLMB_CNTLR0 */
#define XPAR_DLMB_CNTLR0_BASEADDR 0x00000000
#define XPAR_DLMB_CNTLR0_HIGHADDR 0x00003FFF


/* Definitions for peripheral ILMB_CNTLR0 */
#define XPAR_ILMB_CNTLR0_BASEADDR 0x00000000
#define XPAR_ILMB_CNTLR0_HIGHADDR 0x00003FFF


/* Definitions for peripheral VHWTI_GLOBAL_CNTLR1 */
#define XPAR_VHWTI_GLOBAL_CNTLR1_BASEADDR 0xC0000000
#define XPAR_VHWTI_GLOBAL_CNTLR1_HIGHADDR 0xC0000FFF


/* Definitions for peripheral VHWTI_GLOBAL_CNTLR2 */
#define XPAR_VHWTI_GLOBAL_CNTLR2_BASEADDR 0xC0010000
#define XPAR_VHWTI_GLOBAL_CNTLR2_HIGHADDR 0xC0010FFF


/* Definitions for peripheral VHWTI_GLOBAL_CNTLR3 */
#define XPAR_VHWTI_GLOBAL_CNTLR3_BASEADDR 0xC0020000
#define XPAR_VHWTI_GLOBAL_CNTLR3_HIGHADDR 0xC0020FFF


/* Definitions for peripheral VHWTI_GLOBAL_CNTLR4 */
#define XPAR_VHWTI_GLOBAL_CNTLR4_BASEADDR 0xC0030000
#define XPAR_VHWTI_GLOBAL_CNTLR4_HIGHADDR 0xC0030FFF


/* Definitions for peripheral VHWTI_GLOBAL_CNTLR5 */
#define XPAR_VHWTI_GLOBAL_CNTLR5_BASEADDR 0xC0040000
#define XPAR_VHWTI_GLOBAL_CNTLR5_HIGHADDR 0xC0040FFF


/* Definitions for peripheral VHWTI_GLOBAL_CNTLR6 */
#define XPAR_VHWTI_GLOBAL_CNTLR6_BASEADDR 0xC0050000
#define XPAR_VHWTI_GLOBAL_CNTLR6_HIGHADDR 0xC0050FFF
...
/* Definitions for peripheral MICROBLAZE0 */
#define XPAR_MICROBLAZE0_SCO 0
#define XPAR_MICROBLAZE0_FREQ 100000000
#define XPAR_MICROBLAZE0_DATA_SIZE 32
#define XPAR_MICROBLAZE0_DYNAMIC_BUS_SIZING 1
#define XPAR_MICROBLAZE0_FAULT_TOLERANT 0
#define XPAR_MICROBLAZE0_ECC_USE_CE_EXCEPTION 0
#define XPAR_MICROBLAZE0_ENDIANNESS 0
#define XPAR_MICROBLAZE0_AREA_OPTIMIZED 0
#define XPAR_MICROBLAZE0_OPTIMIZATION 0
#define XPAR_MICROBLAZE0_INTERCONNECT 1
#define XPAR_MICROBLAZE0_STREAM_INTERCONNECT 0
#define XPAR_MICROBLAZE0_DPLB_DWIDTH 64
#define XPAR_MICROBLAZE0_DPLB_NATIVE_DWIDTH 32
#define XPAR_MICROBLAZE0_DPLB_BURST_EN 0
#define XPAR_MICROBLAZE0_DPLB_P2P 0
#define XPAR_MICROBLAZE0_IPLB_DWIDTH 64
#define XPAR_MICROBLAZE0_IPLB_NATIVE_DWIDTH 32
#define XPAR_MICROBLAZE0_IPLB_BURST_EN 0
#define XPAR_MICROBLAZE0_IPLB_P2P 0
#define XPAR_MICROBLAZE0_M_AXI_DP_SUPPORTS_THREADS 0
#define XPAR_MICROBLAZE0_M_AXI_DP_THREAD_ID_WIDTH 1
#define XPAR_MICROBLAZE0_M_AXI_DP_SUPPORTS_READ 1
#define XPAR_MICROBLAZE0_M_AXI_DP_SUPPORTS_WRITE 1
#define XPAR_MICROBLAZE0_M_AXI_DP_SUPPORTS_NARROW_BURST 0
#define XPAR_MICROBLAZE0_M_AXI_DP_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_DP_ADDR_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_DP_PROTOCOL AXI4
#define XPAR_MICROBLAZE0_INTERCONNECT_M_AXI_DP_READ_ISSUING 1
#define XPAR_MICROBLAZE0_INTERCONNECT_M_AXI_DP_WRITE_ISSUING 1
#define XPAR_MICROBLAZE0_M_AXI_IP_SUPPORTS_THREADS 0
#define XPAR_MICROBLAZE0_M_AXI_IP_THREAD_ID_WIDTH 1
#define XPAR_MICROBLAZE0_M_AXI_IP_SUPPORTS_READ 1
#define XPAR_MICROBLAZE0_M_AXI_IP_SUPPORTS_WRITE 0
#define XPAR_MICROBLAZE0_M_AXI_IP_SUPPORTS_NARROW_BURST 0
#define XPAR_MICROBLAZE0_M_AXI_IP_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_IP_ADDR_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_IP_PROTOCOL AXI4
#define XPAR_MICROBLAZE0_INTERCONNECT_M_AXI_IP_READ_ISSUING 1
#define XPAR_MICROBLAZE0_D_AXI 0
#define XPAR_MICROBLAZE0_D_PLB 1
#define XPAR_MICROBLAZE0_D_LMB 1
#define XPAR_MICROBLAZE0_I_AXI 0
#define XPAR_MICROBLAZE0_I_PLB 1
#define XPAR_MICROBLAZE0_I_LMB 1
#define XPAR_MICROBLAZE0_USE_MSR_INSTR 0
#define XPAR_MICROBLAZE0_USE_PCMP_INSTR 0
#define XPAR_MICROBLAZE0_USE_BARREL 0
#define XPAR_MICROBLAZE0_USE_DIV 0
#define XPAR_MICROBLAZE0_USE_HW_MUL 0
#define XPAR_MICROBLAZE0_USE_FPU 0
#define XPAR_MICROBLAZE0_UNALIGNED_EXCEPTIONS 0
#define XPAR_MICROBLAZE0_ILL_OPCODE_EXCEPTION 0
#define XPAR_MICROBLAZE0_M_AXI_I_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE0_M_AXI_D_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE0_IPLB_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE0_DPLB_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE0_DIV_ZERO_EXCEPTION 0
#define XPAR_MICROBLAZE0_FPU_EXCEPTION 0
#define XPAR_MICROBLAZE0_FSL_EXCEPTION 0
#define XPAR_MICROBLAZE0_PVR 2
#define XPAR_MICROBLAZE0_PVR_USER1 0x00
#define XPAR_MICROBLAZE0_PVR_USER2 0x00000000
#define XPAR_MICROBLAZE0_DEBUG_ENABLED 1
#define XPAR_MICROBLAZE0_NUMBER_OF_PC_BRK 1
#define XPAR_MICROBLAZE0_NUMBER_OF_RD_ADDR_BRK 0
#define XPAR_MICROBLAZE0_NUMBER_OF_WR_ADDR_BRK 0
#define XPAR_MICROBLAZE0_INTERRUPT_IS_EDGE 0
#define XPAR_MICROBLAZE0_EDGE_IS_POSITIVE 1
#define XPAR_MICROBLAZE0_RESET_MSR 0x00000000
#define XPAR_MICROBLAZE0_OPCODE_0X0_ILLEGAL 0
#define XPAR_MICROBLAZE0_FSL_LINKS 0
#define XPAR_MICROBLAZE0_FSL_DATA_SIZE 32
#define XPAR_MICROBLAZE0_USE_EXTENDED_FSL_INSTR 0
#define XPAR_MICROBLAZE0_M0_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S0_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M1_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S1_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M2_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S2_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M3_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S3_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M4_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S4_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M5_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S5_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M6_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S6_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M7_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S7_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M8_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S8_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M9_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S9_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M10_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S10_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M11_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S11_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M12_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S12_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M13_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S13_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M14_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S14_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M15_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_S15_AXIS_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_ICACHE_BASEADDR 0xA0000000
#define XPAR_MICROBLAZE0_ICACHE_HIGHADDR 0xAFFFFFFF
#define XPAR_MICROBLAZE0_USE_ICACHE 1
#define XPAR_MICROBLAZE0_ALLOW_ICACHE_WR 1
#define XPAR_MICROBLAZE0_ADDR_TAG_BITS 12
#define XPAR_MICROBLAZE0_CACHE_BYTE_SIZE 65536
#define XPAR_MICROBLAZE0_ICACHE_USE_FSL 1
#define XPAR_MICROBLAZE0_ICACHE_LINE_LEN 4
#define XPAR_MICROBLAZE0_ICACHE_ALWAYS_USED 1
#define XPAR_MICROBLAZE0_ICACHE_INTERFACE 0
#define XPAR_MICROBLAZE0_ICACHE_VICTIMS 0
#define XPAR_MICROBLAZE0_ICACHE_STREAMS 0
#define XPAR_MICROBLAZE0_ICACHE_FORCE_TAG_LUTRAM 0
#define XPAR_MICROBLAZE0_ICACHE_DATA_WIDTH 0
#define XPAR_MICROBLAZE0_M_AXI_IC_SUPPORTS_THREADS 0
#define XPAR_MICROBLAZE0_M_AXI_IC_THREAD_ID_WIDTH 1
#define XPAR_MICROBLAZE0_M_AXI_IC_SUPPORTS_READ 1
#define XPAR_MICROBLAZE0_M_AXI_IC_SUPPORTS_WRITE 0
#define XPAR_MICROBLAZE0_M_AXI_IC_SUPPORTS_NARROW_BURST 0
#define XPAR_MICROBLAZE0_M_AXI_IC_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_IC_ADDR_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_IC_PROTOCOL AXI4
#define XPAR_MICROBLAZE0_INTERCONNECT_M_AXI_IC_READ_ISSUING 2
#define XPAR_MICROBLAZE0_DCACHE_BASEADDR 0x00000000
#define XPAR_MICROBLAZE0_DCACHE_HIGHADDR 0x3FFFFFFF
#define XPAR_MICROBLAZE0_USE_DCACHE 0
#define XPAR_MICROBLAZE0_ALLOW_DCACHE_WR 1
#define XPAR_MICROBLAZE0_DCACHE_ADDR_TAG 0
#define XPAR_MICROBLAZE0_DCACHE_BYTE_SIZE 8192
#define XPAR_MICROBLAZE0_DCACHE_USE_FSL 1
#define XPAR_MICROBLAZE0_DCACHE_LINE_LEN 4
#define XPAR_MICROBLAZE0_DCACHE_ALWAYS_USED 0
#define XPAR_MICROBLAZE0_DCACHE_INTERFACE 0
#define XPAR_MICROBLAZE0_DCACHE_USE_WRITEBACK 0
#define XPAR_MICROBLAZE0_DCACHE_VICTIMS 0
#define XPAR_MICROBLAZE0_DCACHE_FORCE_TAG_LUTRAM 0
#define XPAR_MICROBLAZE0_DCACHE_DATA_WIDTH 0
#define XPAR_MICROBLAZE0_M_AXI_DC_SUPPORTS_THREADS 0
#define XPAR_MICROBLAZE0_M_AXI_DC_THREAD_ID_WIDTH 1
#define XPAR_MICROBLAZE0_M_AXI_DC_SUPPORTS_READ 1
#define XPAR_MICROBLAZE0_M_AXI_DC_SUPPORTS_WRITE 1
#define XPAR_MICROBLAZE0_M_AXI_DC_SUPPORTS_NARROW_BURST 0
#define XPAR_MICROBLAZE0_M_AXI_DC_DATA_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_DC_ADDR_WIDTH 32
#define XPAR_MICROBLAZE0_M_AXI_DC_PROTOCOL AXI4
#define XPAR_MICROBLAZE0_INTERCONNECT_M_AXI_DC_READ_ISSUING 2
#define XPAR_MICROBLAZE0_INTERCONNECT_M_AXI_DC_WRITE_ISSUING 32
#define XPAR_MICROBLAZE0_USE_MMU 0
#define XPAR_MICROBLAZE0_MMU_DTLB_SIZE 4
#define XPAR_MICROBLAZE0_MMU_ITLB_SIZE 2
#define XPAR_MICROBLAZE0_MMU_TLB_ACCESS 3
#define XPAR_MICROBLAZE0_MMU_ZONES 16
#define XPAR_MICROBLAZE0_USE_INTERRUPT 1
#define XPAR_MICROBLAZE0_USE_EXT_BRK 1
#define XPAR_MICROBLAZE0_USE_EXT_NM_BRK 1
#define XPAR_MICROBLAZE0_USE_BRANCH_TARGET_CACHE 0
#define XPAR_MICROBLAZE0_BRANCH_TARGET_CACHE_SIZE 0
