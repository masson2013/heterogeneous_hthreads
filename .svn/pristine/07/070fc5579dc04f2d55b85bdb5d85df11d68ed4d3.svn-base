...
set_property is_partial_reconfig true [current_project]
 ...
 planAhead p12new/project_1/project_1.ppr -mode batch -source etc/planahead12.cmd
...
add_reconfig_module -name {crc} -cell {hw_acc_2} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/crc.ngc}
add_reconfig_module -name {crc} -cell {hw_acc_3} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/crc.ngc}
add_reconfig_module -name {crc} -cell {hw_acc_4} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/crc.ngc}
add_reconfig_module -name {crc} -cell {hw_acc_5} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/crc.ngc}
add_reconfig_module -name {crc} -cell {hw_acc_6} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/crc.ngc}

add_reconfig_module -name {sort} -cell {hw_acc_1} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/sort.ngc}
add_reconfig_module -name {sort} -cell {hw_acc_2} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/sort.ngc}
add_reconfig_module -name {sort} -cell {hw_acc_3} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/sort.ngc}
add_reconfig_module -name {sort} -cell {hw_acc_4} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/sort.ngc}
add_reconfig_module -name {sort} -cell {hw_acc_5} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/sort.ngc}
add_reconfig_module -name {sort} -cell {hw_acc_6} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/sort.ngc}

add_reconfig_module -name {vector} -cell {hw_acc_1} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/vector.ngc}
add_reconfig_module -name {vector} -cell {hw_acc_2} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/vector.ngc}
add_reconfig_module -name {vector} -cell {hw_acc_3} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/vector.ngc}
add_reconfig_module -name {vector} -cell {hw_acc_4} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/vector.ngc}
add_reconfig_module -name {vector} -cell {hw_acc_5} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/vector.ngc}
add_reconfig_module -name {vector} -cell {hw_acc_6} -file {/home/abazar63/hthread/src/platforms/xilinx/pr_6smp/design/netlist/vector.ngc}
