-------------------------------------------------------------------------------
-- $Id: srl16_fifo.vhd,v 1.2 2004/11/23 01:04:03 jcanaris Exp $
-------------------------------------------------------------------------------
-- srl16_fifo.vhd
-------------------------------------------------------------------------------
--
...
begin  -- architecture implementation
   ...
   I_OCCUPANCY_CNTR : entity opb_ipif_v2_00_h.pf_occ_counter_top
    generic map(
  ...
  I_ADDR_CNTR : entity opb_ipif_v2_00_h.pf_counter_top
     generic map(
