...
@p_str6 = private unnamed_addr constant [9 x i8] c"add_Loop\00", align 1
@p_str7 = private unnamed_addr constant [9 x i8] c"sub_Loop\00", align 1
@str = internal constant [10 x i8] c"vectoradd\00"
...
define void @vectoradd(i32* %cmd, i32* %resp, [4096 x i32]* %a, [4096 x i32]* %b, [4096 x i32]* %result) noreturn nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32* %cmd, [5 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
  call void (...)* @_ssdm_op_SpecInterface(i32* %resp, [5 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind
...
; <label>:1                                       ; preds = %.loopexit2, %0
  ...
  %tmp_11 = call i32 (...)* @_ssdm_op_SpecRegionBegin([9 x i8]* @p_str5) nounwind
  ...
  br i1 %tmp, label %.preheader1.preheader, label %4
...
.preheader1:                                      ; preds = %._crit_edge, %.preheader1.preheader
  ...
  br i1 %tmp_3, label %2, label %.loopexit2
...
; <label>:2                                       ; preds = %.preheader1
  ...
  br i1 %tmp_7, label %3, label %._crit_edge
...
; <label>:5                                       ; preds = %.preheader
  ...
  %tmp_9 = sub nsw i32 %a_load_1, %b_load_1
...
.loopexit2:                                       ; preds = %.preheader1, %.loopexit
  %empty = call i32 (...)* @_ssdm_op_SpecRegionEnd([9 x i8]* @p_str5, i32 %tmp_11) nounwind
  br label %1
}
