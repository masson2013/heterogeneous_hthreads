...
# Project:/home/abazar63/hthread/src/platforms/xilinx/hwti_mblaze_6smp/design/system.xmp
#
...
# /home/abazar63/hthread/src/platforms/xilinx/hwti_mblaze_6smp/design/system.mhs
# The software specification of the system is in file :
# /home/abazar63/hthread/src/platforms/xilinx/hwti_mblaze_6smp/design/system.mss
...
microblaze0_libsclean:
	rm -rf microblaze0/

microblaze1_libsclean:
	rm -rf microblaze1/

microblaze2_libsclean:
	rm -rf microblaze2/

microblaze3_libsclean:
	rm -rf microblaze3/

microblaze4_libsclean:
	rm -rf microblaze4/

microblaze5_libsclean:
	rm -rf microblaze5/

microblaze6_libsclean:
	rm -rf microblaze6/
...
Core_Test_program: $(CORE_TEST_OUTPUT) 

$(CORE_TEST_OUTPUT) : $(CORE_TEST_SOURCES) $(CORE_TEST_HEADERS) $(CORE_TEST_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/core_test_compiler.opt
	@mkdir -p $(CORE_TEST_OUTPUT_DIR) 
	$(CORE_TEST_CC) $(CORE_TEST_CC_OPT) $(CORE_TEST_SOURCES) -o $(CORE_TEST_OUTPUT) \
	$(CORE_TEST_OTHER_CC_FLAGS) $(CORE_TEST_INCLUDES) $(CORE_TEST_LIBPATH) \
	$(CORE_TEST_CFLAGS) $(CORE_TEST_LFLAGS) 
	$(CORE_TEST_CC_SIZE) $(CORE_TEST_OUTPUT) 
	@echo ""

Core_Test_programclean:
	rm -f $(CORE_TEST_OUTPUT) 

#################################################################
# SOFTWARE APPLICATION MB_HWT0
#################################################################

MB_HWT0_program: $(MB_HWT0_OUTPUT) 

$(MB_HWT0_OUTPUT) : $(MB_HWT0_SOURCES) $(MB_HWT0_HEADERS) $(MB_HWT0_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/mb_hwt0_compiler.opt
	@mkdir -p $(MB_HWT0_OUTPUT_DIR) 
	$(MB_HWT0_CC) $(MB_HWT0_CC_OPT) $(MB_HWT0_SOURCES) -o $(MB_HWT0_OUTPUT) \
	$(MB_HWT0_OTHER_CC_FLAGS) $(MB_HWT0_INCLUDES) $(MB_HWT0_LIBPATH) \
	$(MB_HWT0_CFLAGS) $(MB_HWT0_LFLAGS) 
	$(MB_HWT0_CC_SIZE) $(MB_HWT0_OUTPUT) 
	@echo ""

MB_HWT0_programclean:
	rm -f $(MB_HWT0_OUTPUT) 
...
$(MICROBLAZE0_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE0_BOOTLOOP)

$(MICROBLAZE1_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE1_BOOTLOOP)

$(MICROBLAZE2_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE2_BOOTLOOP)

$(MICROBLAZE3_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE3_BOOTLOOP)

$(MICROBLAZE4_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE4_BOOTLOOP)

$(MICROBLAZE5_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE5_BOOTLOOP)

$(MICROBLAZE6_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE6_BOOTLOOP)
