...
# Project:/home/abazar63/hthread/src/platforms/xilinx/vc707_smp6/design/system.xmp
#
...
BRAMINIT_ELF_IMP_FILES = $(MICROBLAZE_0_BOOTLOOP) $(MICROBLAZE_1_BOOTLOOP) $(MICROBLAZE_2_BOOTLOOP) $(MICROBLAZE_3_BOOTLOOP) $(MICROBLAZE_4_BOOTLOOP) $(MICROBLAZE_5_BOOTLOOP) $(MICROBLAZE_6_BOOTLOOP)
BRAMINIT_ELF_IMP_FILE_ARGS = -pe microblaze_0 $(MICROBLAZE_0_BOOTLOOP) -pe microblaze_1 $(MICROBLAZE_1_BOOTLOOP) -pe microblaze_2 $(MICROBLAZE_2_BOOTLOOP) -pe microblaze_3 $(MICROBLAZE_3_BOOTLOOP) -pe microblaze_4 $(MICROBLAZE_4_BOOTLOOP) -pe microblaze_5 $(MICROBLAZE_5_BOOTLOOP) -pe microblaze_6 $(MICROBLAZE_6_BOOTLOOP)

BRAMINIT_ELF_SIM_FILES = $(MICROBLAZE_0_BOOTLOOP) $(MICROBLAZE_1_BOOTLOOP) $(MICROBLAZE_2_BOOTLOOP) $(MICROBLAZE_3_BOOTLOOP) $(MICROBLAZE_4_BOOTLOOP) $(MICROBLAZE_5_BOOTLOOP) $(MICROBLAZE_6_BOOTLOOP)
BRAMINIT_ELF_SIM_FILE_ARGS = -pe microblaze_0 $(MICROBLAZE_0_BOOTLOOP) -pe microblaze_1 $(MICROBLAZE_1_BOOTLOOP) -pe microblaze_2 $(MICROBLAZE_2_BOOTLOOP) -pe microblaze_3 $(MICROBLAZE_3_BOOTLOOP) -pe microblaze_4 $(MICROBLAZE_4_BOOTLOOP) -pe microblaze_5 $(MICROBLAZE_5_BOOTLOOP) -pe microblaze_6 $(MICROBLAZE_6_BOOTLOOP)
...
WRAPPER_NGC_FILES = implementation/system_vhwti_lite_wrapper.ngc \
implementation/system_vhwti_local_cntlr_1_wrapper.ngc \
implementation/system_vhwti_global_cntlr_1_wrapper.ngc \
implementation/system_vhwti_bram_1_wrapper.ngc \
implementation/system_vhwti_local_cntlr_2_wrapper.ngc \
implementation/system_vhwti_global_cntlr_2_wrapper.ngc \
implementation/system_vhwti_bram_2_wrapper.ngc \
implementation/system_vhwti_local_cntlr_3_wrapper.ngc \
implementation/system_vhwti_global_cntlr_3_wrapper.ngc \
implementation/system_vhwti_bram_3_wrapper.ngc \
implementation/system_vhwti_local_cntlr_4_wrapper.ngc \
implementation/system_vhwti_global_cntlr_4_wrapper.ngc \
implementation/system_vhwti_bram_4_wrapper.ngc \
implementation/system_vhwti_local_cntlr_5_wrapper.ngc \
implementation/system_vhwti_global_cntlr_5_wrapper.ngc \
implementation/system_vhwti_bram_5_wrapper.ngc \
implementation/system_vhwti_local_cntlr_6_wrapper.ngc \
implementation/system_vhwti_global_cntlr_6_wrapper.ngc \
implementation/system_vhwti_bram_6_wrapper.ngc \
...
implementation/system_group_lite_2_wrapper.ngc \
implementation/system_group_2_main_axi_bridge_wrapper.ngc \
implementation/system_microblaze_2_wrapper.ngc \
implementation/system_microblaze_2_ilmb_wrapper.ngc \
implementation/system_microblaze_2_i_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_2_dlmb_wrapper.ngc \
implementation/system_microblaze_2_d_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_2_bram_block_wrapper.ngc \
implementation/system_group_lite_3_wrapper.ngc \
implementation/system_group_3_main_axi_bridge_wrapper.ngc \
implementation/system_microblaze_3_wrapper.ngc \
implementation/system_microblaze_3_ilmb_wrapper.ngc \
implementation/system_microblaze_3_i_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_3_dlmb_wrapper.ngc \
implementation/system_microblaze_3_d_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_3_bram_block_wrapper.ngc \
implementation/system_group_lite_4_wrapper.ngc \
implementation/system_group_4_main_axi_bridge_wrapper.ngc \
implementation/system_microblaze_4_wrapper.ngc \
implementation/system_microblaze_4_ilmb_wrapper.ngc \
implementation/system_microblaze_4_i_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_4_dlmb_wrapper.ngc \
implementation/system_microblaze_4_d_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_4_bram_block_wrapper.ngc \
implementation/system_group_lite_5_wrapper.ngc \
implementation/system_group_5_main_axi_bridge_wrapper.ngc \
implementation/system_microblaze_5_wrapper.ngc \
implementation/system_microblaze_5_ilmb_wrapper.ngc \
implementation/system_microblaze_5_i_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_5_dlmb_wrapper.ngc \
implementation/system_microblaze_5_d_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_5_bram_block_wrapper.ngc \
implementation/system_group_lite_6_wrapper.ngc \
implementation/system_group_6_main_axi_bridge_wrapper.ngc \
implementation/system_microblaze_6_wrapper.ngc \
implementation/system_microblaze_6_ilmb_wrapper.ngc \
implementation/system_microblaze_6_i_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_6_dlmb_wrapper.ngc \
implementation/system_microblaze_6_d_bram_ctrl_wrapper.ngc \
implementation/system_microblaze_6_bram_block_wrapper.ngc \
